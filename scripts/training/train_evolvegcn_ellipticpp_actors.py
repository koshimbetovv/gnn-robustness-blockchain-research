...
CONFIG_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "config", "models", "train_evolvegcn_ellipticpp_actors_h.json")
...
def main():
    ...
    save_run(model, test_metrics, CONFIG, CONFIG["save"]["prefix"])
