...
def main():
    ...
    atk = CoSemiPGDAttack(model, device, raw_feature_dim=raw_feature_dim, clamp=CLAMP)
    ...
    print()
    print(f"PGD CoSemiGNN | eps={EPS} alpha={ALPHA} steps={STEPS} random_start={RANDOM_START}")
