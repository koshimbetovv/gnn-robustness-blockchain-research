...
from src.attacks.fgsm_evolvegcn import EvolveGCNFGSMAttack
...
def main():
    ...
    for sample in sequence.test_samples:
        ...
        # columns [attack_start_col:] are actually perturbed by FGSM, so we
    ...
    print()
    print(f"FGSM EvolveGCN-O | eps={EPS}")
