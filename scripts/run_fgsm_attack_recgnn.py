...
from src.attacks.fgsm_recgnn import RecGNNFGSMAttack
...
# are excluded from FGSM. `None` selects the dataset-appropriate default.
ATTACK_DIM = None
...
def main():
    ...
    atk = RecGNNFGSMAttack(model, device, attack_dim=attack_dim, clamp=CLAMP)
