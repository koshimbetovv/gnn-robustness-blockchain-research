...
class EvolveGCNFGSMAttack:
    """FGSM for EvolveGCN-O, operating one test window at a time.
    ...
    def attack_window(
        ...
        """Single-step FGSM on one window.
        ...
        hist_out = self._build_perturbed_list(hist_ndFeats_list, target_nodes, delta_adv.detach())
